...
RENGLISH_RCDEP = d:\data\refs\refs.h
...
RENGLISH.RES:	RENGLISH.RC $(RENGLISH_RCDEP)
	$(RC) $(RCFLAGS) $(RCDEFINES) -r RENGLISH.RC


$(PROJ).DLL::	RENGLISH.RES
...
<<
	...
	$(RC) $(RESFLAGS) RENGLISH.RES $@
	@copy $(PROJ).CRF MSVC.BND
	implib /nowep $(PROJ).LIB $(PROJ).DLL

$(PROJ).DLL::	RENGLISH.RES
	if not exist MSVC.BND 	$(RC) $(RESFLAGS) RENGLISH.RES $@
