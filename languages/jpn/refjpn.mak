...
REFJPN_RCDEP = d:\data\refs\refs.h
...
REF95JPN.RES:	REF95JPN.RC $(REFJPN_RCDEP)
	$(RC) $(RCFLAGS) $(RCDEFINES) -r REFJPN.RC
...
<<
	...
	$(RC) $(RESFLAGS) REFJPN.RES $@
	@copy $(PROJ).CRF MSVC.BND
	implib /nowep $(PROJ).LIB $(PROJ).DLL

$(PROJ).DLL::	REFJPN.RES
	if not exist MSVC.BND 	$(RC) $(RESFLAGS) REFJPN.RES $@
