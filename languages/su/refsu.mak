...
REFSU_RCDEP = d:\data\refs\refs.h
...
REFSU.RES:   REFSU.RC $(REFSU_RCDEP)
	$(RC) $(RCFLAGS) $(RCDEFINES) -r REFSU.RC
...
<<
	...
	$(RC) $(RESFLAGS) REFSU.RES $@
	@copy $(PROJ).CRF MSVC.BND
	implib /nowep $(PROJ).LIB $(PROJ).DLL

$(PROJ).DLL::   REFSU.RES
	if not exist MSVC.BND   $(RC) $(RESFLAGS) REFSU.RES $@
